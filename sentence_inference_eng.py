...
def encode_scrambled_sentences(data, mapping, chars):
    ...
    for i in range(len(data)):
        ...
        encoded_sentence = [mapping[char] if char in chars else 66 for char in labeled_sentence]
        ...
        if len(scrambled_sentences) > 2:
            for j in scrambled_sentences:
                ...
                if len(j) > 0:
                    ...
                    encoded = [mapping[char] if char in chars else 66 for char in j]
...
if __name__ == '__main__':
    ...
    true_sentences = pd.read_csv('english.csv', encoding='latin1')
    ...
    eng_model_v1 = build_language_model(input_length=100, 
                                        embedding_size = 16,
                                        LSTM_size=256, 
                                        dropout_prob=.2, 
                                        vocab_size=67,
    ...
    new_model = load_trained_model(eng_model_v1, 
                                   'eng_model//weights-06-1.112-1.000.hdf5')
    print('Language Model Loaded')

    #permute_9 = convert_permutations_to_list('permutations/english_permutations_9.csv')
    ...
    #permute_9_prob.to_csv('probabilities/en_probabilities_9gram.csv')


    #permute_8 = convert_permutations_to_list('permutations/english_permutations_8.csv')
    #print('Permutation dataset created')
    ...
    #permute_8_prob.to_csv('probabilities/en_probabilities_8gram.csv')


    permute_7 = convert_permutations_to_list('permutations/english_permutations_7.csv')
    print('Permutation dataset created')
    ...
    permute_7_prob.to_csv('C:/Users/kl2596/Google Drive/Mathematics and Data Science Classes/Natural Language Understanding/Project/Code/probabilities/new_prob/en_probabilities_7gram.csv')


    permute_6 = convert_permutations_to_list('permutations/english_permutations_6.csv')
    print('Permutation dataset created')
    ...
    permute_6_prob.to_csv('C:/Users/kl2596/Google Drive/Mathematics and Data Science Classes/Natural Language Understanding/Project/Code/probabilities/new_prob/en_probabilities_6gram.csv')


    permute_7_prob = get_probability(new_model, permute_7_encode.iloc[500:1000,:], 7)
    permute_7_prob.to_csv('C:/Users/kl2596/Google Drive/Mathematics and Data Science Classes/Natural Language Understanding/Project/Code/probabilities/new_prob/en_probabilities_7gram2.csv')


    permute_6_prob = get_probability(new_model, permute_6_encode.iloc[500:1000,:], 6)
    permute_6_prob.to_csv('C:/Users/kl2596/Google Drive/Mathematics and Data Science Classes/Natural Language Understanding/Project/Code/probabilities/new_prob/en_probabilities_6gram2.csv')


    #permute_5 = convert_permutations_to_list('permutations/english_permutations_5.csv')
    #print('Permutation dataset created')
    ...
    #permute_5_prob.to_csv('probabilities/en_probabilities_5gram.csv')


    #permute_4 = convert_permutations_to_list('permutations/english_permutations_4.csv')
    #print('Permutation dataset created')
    ...
    #permute_4_prob.to_csv('probabilities/en_probabilities_4gram.csv')