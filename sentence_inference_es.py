        ...
        if len(scrambled_sentences) > 2:
            for j in scrambled_sentences:
                ...
                if len(j) > 0:
                    ...
                    encoded = [mapping[char] for char in j]
            ...
            for k in encoded_data.iloc[i, 1]:
                ...
                for m in range(1, len(k)):
                    if m < 100:
                        ...
                        temp_seq = pad_sequences(temp_seq, 100)
                    else:
...
if __name__ == '__main__':
    ...
    true_sentences = pd.read_csv('spanish.csv', encoding='utf-8')
    ...
    # Creates mapping for each language
    chars = sorted(list(set(raw_text)))
    # For spanish we only take the top 256 characters (there are way too many because of the presence of other languages)
    #chars = chars[0:66] # change this line for other languages
    mapping = dict((c, i) for i, c in enumerate(chars))
    print(mapping)

    '''spa_model_v1 = build_language_model(input_length=100, 
                                        embedding_size = 16,
                                        LSTM_size=256, 
                                        dropout_prob=.2, 
    ...
    new_model = load_trained_model(spa_model_v1, 
                                      'spa_model//weights-02-1.736-1.000.hdf5')
    print('Language Model Loaded')'''

    
    '''permute_9 = convert_permutations_to_list('permutations/spanish_permutations_9.csv')
    ...
    permute_9_prob = get_probability(new_model, permute_9_encode.iloc[:1000,:], 9)
    permute_9_prob.to_csv('probabilities/es_probabilities_9gram.csv')


    permute_8 = convert_permutations_to_list('permutations/spanish_permutations_8.csv')
    print('Permutation dataset created')
    ...
    print('Permutation dataset encoded')
    permute_8_prob = get_probability(new_model, permute_8_encode.iloc[:1000,:], 8)
    permute_8_prob.to_csv('probabilities/es_probabilities_8gram.csv')'''


    '''permute_7 = convert_permutations_to_list('permutations/spanish_permutations_7.csv')
    print('Permutation dataset created')
    ...
    permute_7_prob.to_csv('C:/Users/kl2596/Google Drive/Mathematics and Data Science Classes/Natural Language Understanding/Project/Code/probabilities/new_prob/es_probabilities_7gram.csv')


    permute_6 = convert_permutations_to_list('permutations/spanish_permutations_6.csv')
    print('Permutation dataset created')
    ...
    permute_6_prob.to_csv('C:/Users/kl2596/Google Drive/Mathematics and Data Science Classes/Natural Language Understanding/Project/Code/probabilities/new_prob/es_probabilities_6gram.csv')


    permute_7_prob = get_probability(new_model, permute_7_encode.iloc[500:1000,:], 7)
    permute_7_prob.to_csv('C:/Users/kl2596/Google Drive/Mathematics and Data Science Classes/Natural Language Understanding/Project/Code/probabilities/new_prob/es_probabilities_7gram2.csv')

    permute_6_prob = get_probability(new_model, permute_6_encode.iloc[500:1000,:], 6)
    permute_6_prob.to_csv('C:/Users/kl2596/Google Drive/Mathematics and Data Science Classes/Natural Language Understanding/Project/Code/probabilities/new_prob/es_probabilities_6gram2.csv')

    '''
    '''permute_5 = convert_permutations_to_list('permutations/spanish_permutations_5.csv')
    print('Permutation dataset created')
    ...
    permute_5_prob.to_csv('probabilities/es_probabilities_5gram.csv')


    permute_4 = convert_permutations_to_list('permutations/spanish_permutations_4.csv')
    print('Permutation dataset created')
    ...
    permute_4_prob.to_csv('probabilities/es_probabilities_4gram.csv')'''