...
def main():
	...
	model_path = path + '/%s_lr%s_dr%s_inputsize%s_embeddingsize%s_LSTMsize%s_gpu%s/' % ('English', .001, .2, 10, 16, 256, 0) #(FLAGS.learning_rate, FLAGS.drop_rate, FLAGS.input_size, FLAGS.embedding_size, FLAGS.LSTM_size, FLAGS.GPU_num)
